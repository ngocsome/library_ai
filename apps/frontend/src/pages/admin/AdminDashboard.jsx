  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Tổng người dùng" value={stats.counts.users} icon={Users} color="bg-blue-600" delay={0.1} />
        <StatCard title="Tài liệu số" value={stats.counts.documents} icon={FileText} color="bg-emerald-600" delay={0.2} />
        <StatCard title="Bài viết diễn đàn" value={stats.counts.posts} icon={MessageSquare} color="bg-violet-600" delay={0.3} />
        <StatCard title="Nhóm học tập" value={stats.counts.groups} icon={Target} color="bg-orange-600" delay={0.4} />
      </div>
                ...
                >
                  <div className="flex items-center gap-4 min-w-0">
                    ...
                    <div className="truncate">
                      ...
                      <p className="text-xs text-slate-500 mt-1">Tài liệu có lượt xem cao</p>
                    </div>
                  </div>
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <p className="text-indigo-100 text-sm leading-relaxed mb-6">
              Dữ liệu dashboard được lấy trực tiếp từ backend. Nếu số liệu vẫn là 0, hãy kiểm tra database đã có dữ liệu chưa.
            </p>
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <button
                type="button"
                onClick={() => navigate('/admin/documents?pending=1')}
                className="flex items-center gap-3 p-4 bg-slate-50 hover:bg-slate-100 rounded-2xl transition-all text-sm font-bold text-slate-700 group"
              >
                <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-sm group-hover:text-primary-600 transition-colors">
                  <FileText size={16} />
