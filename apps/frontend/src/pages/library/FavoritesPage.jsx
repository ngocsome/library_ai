...
const FavoritesPage = () => {
  ...
  return (
    <div className="container mx-auto px-6 pt-15 pb-20 space-y-6 relative z-10 max-w-6xl">
      ...
      {/* Main Content Area */}
      {loading ? (
        <div className="flex justify-center items-center min-h-[260px] py-16">
            ...
            return (
              ...
              >
                ...
                <Link
                  ...
                  className="flex flex-col h-full p-2.5"
                >
        ...
        <div className="text-center py-16 bg-white/60 backdrop-blur-md rounded-[32px] border-2 border-dashed border-slate-200 p-8 shadow-sm max-w-xl mx-auto flex flex-col items-center justify-center">
